...
public class IPBasedTokenBucketRateLimitingFilter implements RateLimitingFilter {

	private TokenBucketRateLimitingService rateLimitingService;

	public IPBasedTokenBucketRateLimitingFilter(TokenBucketRateLimitingService rateLimitingService) {
